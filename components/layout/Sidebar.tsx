...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Facebook Posts", href: "/promote/facebook", icon: ThumbsUp, alertPlatform: "facebook" },
      { label: "Instagram Posts", href: "/promote/instagram", icon: Camera, alertPlatform: "instagram" },
